...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit.setGeometry(QtCore.QRect(0, 0, 341, 441))
        self.textEdit.setObjectName("textEdit")
        self.verticalLayoutWidget = QtWidgets.QWidget(parent=self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(370, 0, 321, 413))
        ...
        self.btn_delette_note = QtWidgets.QPushButton(parent=self.verticalLayoutWidget)
        self.btn_delette_note.setObjectName("btn_delette_note")
        self.horizontalLayout.addWidget(self.btn_delette_note)
        ...
        self.btn_search_tag = QtWidgets.QPushButton(parent=self.verticalLayoutWidget)
        self.btn_search_tag.setObjectName("btn_search_tag")
        self.verticalLayout.addWidget(self.btn_search_tag)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Список нотатків"))
        self.btn_create_note.setText(_translate("MainWindow", "Створити нотатку"))
        self.btn_delette_note.setText(_translate("MainWindow", "Видалити нотатку"))
        self.save_note.setText(_translate("MainWindow", "Зберегти замітку"))
        ...
        self.btn_search_tag.setText(_translate("MainWindow", "Шукат по тегу"))
